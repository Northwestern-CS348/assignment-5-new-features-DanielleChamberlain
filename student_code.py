...
def buildFeatureStatement(tree):
    ...
    roooot = languageTools.extractRoot(tree)

    # To get the subject of a verb, we use languageTools.extractSubject on the ROOT
    sub = languageTools.extractSubject(roooot)
    ...
    # other functions
    res = core.resolveObjectFOPC(sub)
    ...
    core.findAndAttachPrepObjectsFOPC(roooot, sub, res)
    ...
    core.findAndAssertFeaturesFOPC(roooot, res)
    core.findAndAssertDefinitionsFOPC(roooot, res)
